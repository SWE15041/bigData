package com.bigdata.util.ip;

import com.bigdata.util.file.FileUtil;
import com.bigdata.util.file.PoiUtil;
...
public class IpHelper {
    ...
    private static final String ipFile = "resources/ipDatabase.csv";

    private static final String regionFile = "resources/ipRegion.xlsx";
    ...
    public static Map<Integer, String> getRegionRelationMap() throws Exception {
        System.out.println(IpHelper.class.getClassLoader().getResource(""));
